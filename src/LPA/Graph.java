...
//			}
	 ...
	 */
	//source->dest
	private void addEdge(Integer source, Integer dest,Double value) {
		...
		sourceNode.addNeighbour(destNode,value);
		destNode.addbeNeighbour(sourceNode,value);
	}
